          ...
          <div className="flex-1">
            <div className="relative">
              <Input
                ...
                className="h-9 w-full rounded-full border-0 bg-card pl-10 pr-4 text-sm text-foreground placeholder:text-muted-foreground focus-visible:ring-0 focus-visible:ring-offset-0"
              />
